...
vs_handler_func vs_handler[] = {
    ...
    &vmin_vs_handler,
    &vmladava_vs_handler,
    &vmladavax_vs_handler,
    &vmladav_vs_handler,
    &vmladavx_vs_handler,
    &vmlaldava_vs_handler,
    &vmlaldavax_vs_handler,
    &vmlaldav_vs_handler,
    &vmlaldavx_vs_handler,
    &vmlas_vs_handler,
    &vmla_vs_handler,
    &vmlsdava_vs_handler,
    &vmlsdavax_vs_handler,
    &vmlsdav_vs_handler,
    &vmlsdavx_vs_handler,
    &vmlsldava_vs_handler,
    &vmlsldavax_vs_handler,
    &vmlsldav_vs_handler,
    &vmlsldavx_vs_handler,
    &vmovlb_vs_handler,
    &vmovlt_vs_handler,
    &vmovnb_vs_handler,
    &vmovnt_vs_handler,
    ...
    &vqabs_vs_handler,
    &vqadd_vs_handler,
    &vqdmladhx_vs_handler,
    &vqdmladh_vs_handler,
    &vqdmlah_vs_handler,
    &vqdmlash_vs_handler,
    &vqdmlsdhx_vs_handler,
    &vqdmlsdh_vs_handler,
    &vqdmulh_vs_handler,
    &vqdmullb_vs_handler,
    &vqdmullt_vs_handler,
    ...
    &vqmovunt_vs_handler,
    &vqneg_vs_handler,
    &vqrdmladhx_vs_handler,
    &vqrdmladh_vs_handler,
    &vqrdmlah_vs_handler,
    &vqrdmlash_vs_handler,
    &vqrdmlsdhx_vs_handler,
    &vqrdmlsdh_vs_handler,
    &vqrdmulh_vs_handler,
    &vqrshl_vs_handler,
    &vqrshrnb_vs_handler,
    &vqrshrnt_vs_handler,
    &vqrshrunb_vs_handler,
    &vqrshrunt_vs_handler,
    &vqshlu_vs_handler,
    &vqshl_vs_handler,
    &vqshrnb_vs_handler,
    &vqshrnt_vs_handler,
    ...
    &vrintx_vs_handler,
    &vrintz_vs_handler,
    &vrmlaldavha_vs_handler,
    &vrmlaldavhax_vs_handler,
    &vrmlaldavh_vs_handler,
    &vrmlaldavhx_vs_handler,
    &vrmlsldavha_vs_handler,
    &vrmlsldavhax_vs_handler,
    &vrmlsldavh_vs_handler,
    &vrmlsldavhx_vs_handler,
    &vrmulh_vs_handler,
    &vrshl_vs_handler,
    &vrshrnb_vs_handler,
    &vrshrnt_vs_handler,
    ...
    &sha256h_vs_handler,
    &sha256h2_vs_handler,
    &sha256su0_vs_handler,
    &sha256su1_vs_handler,
    &shadd16_vs_handler,
    &shadd8_vs_handler,
    &shasx_vs_handler,
    &shsax_vs_handler,
